<h1 align="center">👋 Alfredo Mello</h1>
...
**Desenvolvedor FullStack** com experiência em projetos web estruturados, atuando no
desenvolvimento e manutenção de sistemas frontend e backend. Possuo vivência
em **organização de código**, **separação de responsabilidades** e aplicação de **boas práticas**
de desenvolvimento, participando ativamente da evolução de projetos reais,
com autonomia técnica e foco em qualidade, manutenibilidade e escalabilidade das
soluções. Fluente em inglês, com capacidade para comunicação técnica e
colaboração em ambientes internacionais..  
...
I am a **Full Stack Developer** passionate about technology and innovation.  
Currently pursuing a degree in **Systems Analysis and Development at ULBRA**, I align theory and practice to build **robust, scalable, and reliable systems**.  

I am especially interested in **ERP, test automation, and software development best practices**.  
...
#### 🧪 Quality  
<p align="left">
  <img src="https://img.shields.io/badge/-Test%20Automation-4CAF50?style=for-the-badge&logo=testing-library&logoColor=white"/>  
</p>
